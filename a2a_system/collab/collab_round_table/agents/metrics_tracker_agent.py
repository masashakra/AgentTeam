...
from logger_rt import log_metric

AGENT_PORT = int(os.getenv("METRICS_TRACKER_PORT", "8017"))
AGENT_HOST = os.getenv("AGENT_HOST", "localhost")
AGENT_URL = os.getenv("METRICS_TRACKER_URL", f"http://{AGENT_HOST}:{AGENT_PORT}")
